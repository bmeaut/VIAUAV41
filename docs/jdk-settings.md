...
Specifically, if you're to use JavaFX on JDK8, make sure you're using a JDK version that includes `jfxrt.jar` (as seen in the image above). A distribution that definitely includes this is [Oracle JDK8](https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html). 
