...
> [Starting in Kotlin 1.7.20](https://kotlinlang.org/docs/whatsnew1720.html#preview-of-the-operator-for-creating-open-ended-ranges), a new `..<` operator for creating open-ended ranges is available as an experimental, opt-in language feature. You can learn more about this operator in its [KEEP document](https://github.com/Kotlin/KEEP/blob/open-ended-ranges/proposals/open-ended-ranges.md) or in the [official showcase video](https://www.youtube.com/watch?v=v0AHdAIBnbs).
