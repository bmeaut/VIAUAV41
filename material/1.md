...
> Kotlin allows [trailing commas](https://kotlinlang.org/docs/reference/whatsnew14.html#trailing-comma) in places like parameter lists. You might have noticed this in the previous snippet. This makes it easier to rearrange lines (even in simple text editors), and also makes version control history neater.
