...
This is what an empty class looks like in Kotlin. Classes usually have bodies bounded by curly braces `{}`, but these can be omitted if the class is empty - which will happen in Kotlin more than you'd think.
