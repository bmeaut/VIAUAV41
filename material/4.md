...
> The [`repeat`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/repeat.html) function is actually part of the Standard Library, so you don't need to implement it yourself.
